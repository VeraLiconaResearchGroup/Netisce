...
url<-'https://raw.githubusercontent.com/VeraLiconaResearchGroup/Netisce/main/ipsc/results/silhouette.png'
...
<!-- knitr::kable(DACs,escape=F) %>% kable_styling(font_size = 8) %>% scroll_box(width = "100%", box_css = "border: 0px;")   -->
<!-- ``` -->
