...
params.expressions = "$baseDir/input_data/expressions-40percent.csv"
exp = file(params.expressions)
params.network = "$baseDir/input_data/network.sif"
params.samples = "$baseDir/input_data/samples-subsamp.txt"
...
params.kmeans_max_val = 9


params.num_nodes = 136 // that have expression data
